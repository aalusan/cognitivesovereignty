  ...
  return (
    <div className="font-serif bg-white text-gray-900 min-h-screen p-8 max-w-4xl mx-auto leading-relaxed text-lg">
      <header className="text-center mb-16 border-b border-gray-900 pb-8">
        <h1 className="text-3xl font-bold uppercase tracking-tighter mb-4 text-gray-900">Cognitive Sovereignty</h1>
        <p className="text-xl italic text-gray-700">On the Ownership of Human Judgment in the Age of Autonomous AI</p>
      </header>

      <section className="mb-12">
        <h2 className="text-xl font-bold uppercase tracking-widest border-b border-gray-200 mb-6 pb-2 text-gray-900">Abstract</h2>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-bold uppercase tracking-widest border-b border-gray-200 mb-6 pb-2 text-gray-900">I. The Property Problem</h2>
        <p className="mb-4 text-gray-800">
      ...
      <section className="mb-12">
        <h2 className="text-xl font-bold uppercase tracking-widest border-b border-gray-200 mb-6 pb-2 text-gray-900">II. The Extraction Mechanism</h2>
        <p className="mb-4 text-gray-800">
